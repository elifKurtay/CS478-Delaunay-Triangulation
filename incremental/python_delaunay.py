...
class Graph():
    ...
    # Generates the complete Delaunay mesh by testing every possible triangle for the Delaunay condition,
    # then marking any edges that intersect, and removing the longer of the intersecting edges
